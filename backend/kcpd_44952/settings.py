"""
Django settings for kcpd_44952 project.
...
WSGI_APPLICATION = 'kcpd_44952.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kcpd_44952 API",
    "DESCRIPTION": "API documentation for kcpd_44952 App",
    "VERSION": "v1",
}
